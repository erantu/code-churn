...
void sendNotificationToDevOps() {
 ...
 sendNotificationToCDD useSourceCodeRepositoryNameAsApplicationName: true,
  ...
  releaseTokens: '{}',
  testSources: '[{"name": "${DEVOPS_APPLICATION_NAME}_testSource", "parameters": {"numberOfTestSuites":"${NUMBER_OF_TEST_SUITES}", "numberOfRecentlyFailedTestSuites":"${NUMBER_OF_FLAKY_TEST_SUITES}"}}]',
  scope: "APPLICATION",
