...
void sendNotificationToDevOps() {
 ...
 sendNotificationToCDD useSourceCodeRepositoryNameAsApplicationName: true,
  ...
  releaseTokens: '{"ReleaseTokenTemplate/NUMBER_OF_FLAKY_TEST_SUITES":"${NUMBER_OF_FLAKY_TEST_SUITES}"}',
  testSources: '[{"name": "${DEVOPS_APPLICATION_NAME}", "parameters": {"numberOfTestSuites":"${NUMBER_OF_TEST_SUITES}", "numberOfFlakyTestSuites":"${NUMBER_OF_FLAKY_TEST_SUITES}"}}]',
  scope: "APPLICATION",
